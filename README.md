...
- `Neumann`: $\dfrac{\partial u(a, t)}{\partial x} = a_0\left(u(a, t), a, t\right)$.
- `Dirichlet`: $u(a, t) = a_0\left(u(a, t), a, t\right)$ (this is not an implicit equation for $u(a, t)$, rather $u(a, t)$ is mapped from $a_0\left(u(a, t), a, t\right)$.
